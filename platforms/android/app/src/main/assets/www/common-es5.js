...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function node_modulesIonicCoreDistEsmFrameworkDelegate94e770ccJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var attachComponent = function attachComponent(_x, _x2, _x3, _x4, _x5) {
      return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(delegate, container, component, cssClasses, componentProps) {
        var el;
  ...
  function node_modulesIonicCoreDistEsmThemeFf3fc52fJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var openURL = function openURL(_x6, _x7, _x8, _x9) {
      return (_ref2 = _ref2 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url, ev, direction, animation) {
        var router;

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[28], {
  ...
  function node_modulesIonicCoreDistEsmIonRippleEffectEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RippleEffect = /*#__PURE__*/function (_addRipple) {
      ...
      _createClass(RippleEffect, [{
        key: "addRipple",
        value: function addRipple(_x, _x2) {
          return (_addRipple = _addRipple || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(x, y) {
            var _this = this;

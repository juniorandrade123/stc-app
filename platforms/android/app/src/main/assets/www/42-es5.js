...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[42], {
  ...
  function node_modulesIonicCoreDistEsmIonVirtualScrollEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var VirtualScroll = /*#__PURE__*/function (_connectedCallback, _checkRange, _checkEnd) {
      ...
      _createClass(VirtualScroll, [{
        ...
        key: "checkRange",
        value: function checkRange(_x) {
          return (_checkRange = _checkRange || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(offset) {
            var len,
                length,
                cellIndex,
                cells,
        ...
        value: function checkEnd() {
          return (_checkEnd = _checkEnd || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {

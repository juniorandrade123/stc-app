...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[22], {
  ...
  function node_modulesIonicCoreDistEsmIonPopoverEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Popover = /*#__PURE__*/function (_present, _dismiss) {
      ...
      _createClass(Popover, [{
        ...
        key: "dismiss",
        value: function dismiss(_x, _x2) {
          return (_dismiss = _dismiss || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data, role) {
            var shouldDismiss;

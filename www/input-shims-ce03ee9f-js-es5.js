...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["input-shims-ce03ee9f-js"], {
  ...
  function node_modulesIonicCoreDistEsmInputShimsCe03ee9fJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var jsSetFocus = function jsSetFocus(_x, _x2, _x3, _x4, _x5) {
      return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(componentEl, inputEl, contentEl, footerEl, keyboardHeight) {
        var scrollData, _ref2, scrollContentTimeout, scrollContent, doubleKeyboardEventListener, scrollEl, totalScrollAmount;
    ...
    var startInputShims = function startInputShims(config) {
      ...
      var registerInput = function registerInput(_x6) {
        return (_ref3 = _ref3 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(componentEl) {
